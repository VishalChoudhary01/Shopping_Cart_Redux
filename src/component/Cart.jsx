    ...
    return (
        <>
            {isOpen && (
                ...
                >
                    <section
                        className={`fixed top-0 right-0 lg:w-1/4 md:w-[60%] w-[65%] h-full bg-white shadow-lg z-50 transform transition-transform duration-300 ${
                            isOpen ? "translate-x-0" : "-translate-x-full"
                        }`}
                        onClick={(e) => e.stopPropagation()} // Prevent click propagation to close the modal unintentionally
                    >
                        <section className="lg:p-4 p-2 lg:mr-0 sm:mr-2">
